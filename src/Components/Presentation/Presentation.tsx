    ...
    return (
      <PresentationSec>
        <HeaderPresentation>
          ...
          <Stacks>
            <Stack>
              <StackLink iconSize={34} showTitle={false} title="Java">
                <FaJava className="icon" />
                <p>Java</p>
              </StackLink>
            </Stack>
            <Stack>
              <StackLink iconSize={34} showTitle={false} title="Spring Boot">
            ...
            <Stack>
              <StackLink>
                <StackLink iconSize={34} showTitle={false} title="Postgres">
